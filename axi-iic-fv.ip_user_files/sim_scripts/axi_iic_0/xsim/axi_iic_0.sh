...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L lib_pkg_v1_0_4 -L lib_cdc_v1_0_3 -L axi_lite_ipif_v3_0_4 -L interrupt_control_v3_1_5 -L axi_iic_v2_1_7 -L xil_defaultlib -L secureip -L xpm --snapshot axi_iic_0 xil_defaultlib.axi_iic_0 -log elaborate.log
}
